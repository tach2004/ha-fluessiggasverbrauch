...
| „custom element doesn't exist: lpg-tank-card", sporadisch | Behoben in 2.0.1. Die Karte wurde zusätzlich als Skript-Tag ins HTML eingebunden und konnte dadurch laufen, bevor das Frontend seinen Registry-Polyfill installiert hatte – danach war sie für Lovelace unsichtbar. Jetzt kommt sie nur über die Ressourcenliste. **Nach dem Update einmal den Frontend-Cache zurücksetzen**, sonst liefert der Service Worker bis zu 24 Stunden die alte Seite mit dem Skript-Tag. |
