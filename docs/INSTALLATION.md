...
| Karte erscheint sporadisch nicht (iOS-App, „nach unten ziehen") | Seit 2.0.1 wird die Karte vorkomprimiert ausgeliefert – 16 statt 53 kB. Das Frontend gibt einer Custom Card nur zwei Sekunden. Bleibt es dabei: einmal *Companion App → Frontend-Cache zurücksetzen*. |
